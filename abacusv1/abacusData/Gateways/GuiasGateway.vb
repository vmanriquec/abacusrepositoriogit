...
' This is a partial class file. The other one is GuiasGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between GuiasObject class and Guias table.
    ''' This class provide CRUD methods for Guias table.
    ''' </summary>
    Public Partial Class GuiasGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As GuiasObjectList) As Boolean
        '    Select Case action

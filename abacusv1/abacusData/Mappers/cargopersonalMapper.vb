...
' This is a partial class file. The other one is cargopersonalMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for cargopersonal entity
    ...
    Public Partial Class cargopersonalMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As cargopersonalList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for cargopersonal entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class cargopersonalLoader
    End Class

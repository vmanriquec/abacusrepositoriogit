...
' This is a partial class file. The other one is ChoferesMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class ChoferesMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ChoferesList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Choferes entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ChoferesLoader
    End Class

...
' This is a partial class file. The other one is registrodevisitasMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for registrodevisitas entity
    ...
    Public Partial Class registrodevisitasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As registrodevisitasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for registrodevisitas entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class registrodevisitasLoader
    End Class

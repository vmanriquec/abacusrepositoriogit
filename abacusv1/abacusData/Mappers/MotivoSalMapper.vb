...
' This is a partial class file. The other one is MotivoSalMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class MotivoSalMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As MotivoSalList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for MotivoSal entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class MotivoSalLoader
    End Class

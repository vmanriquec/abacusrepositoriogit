...
' This is a partial class file. The other one is rutaMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class rutaMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As rutaList) As Boolean
        '    Select Case action
        ...
        '    End Select
        'End Function
        Public Shared Function cargarnombreruta() As DataTable
            Using cn As New SqlConnection(cox)
                Using cmd As New SqlCommand("coop_ruta_GetAll", cn)
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for ruta entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class rutaLoader
    End Class

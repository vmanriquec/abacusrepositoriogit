...
' This is a partial class file. The other one is TCMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class TCMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As TCList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for TC entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class TCLoader
    End Class

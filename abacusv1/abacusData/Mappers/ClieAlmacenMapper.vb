...
' This is a partial class file. The other one is ClieAlmacenMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class ClieAlmacenMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ClieAlmacenList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for ClieAlmacen entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ClieAlmacenLoader
    End Class

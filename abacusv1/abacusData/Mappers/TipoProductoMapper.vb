...
' This is a partial class file. The other one is TipoProductoMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for TipoProducto entity
    ...
    Public Partial Class TipoProductoMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As TipoProductoList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for TipoProducto entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class TipoProductoLoader
    End Class

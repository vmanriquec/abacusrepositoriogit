...
' This is a partial class file. The other one is IngresosDetMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class IngresosDetMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As IngresosDetList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for IngresosDet entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class IngresosDetLoader
    End Class

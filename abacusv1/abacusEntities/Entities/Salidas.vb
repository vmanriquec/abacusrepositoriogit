...
' This is a partial class file. The other one is SalidasEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Salidas entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Salidas entity.
    ''' </summary>
    Public Partial Class SalidasList
         ...
         '    ObjectListHelper<Salidas, SalidasList> Exporter = new ObjectListHelper<Salidas, SalidasList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Salidas entities.
    ''' </summary>

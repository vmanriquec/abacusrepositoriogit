...
' This is a partial class file. The other one is CotizacionDetEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the CotizacionDet entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of CotizacionDet entity.
    ''' </summary>
    Public Partial Class CotizacionDetList
         ...
         '    ObjectListHelper<CotizacionDet, CotizacionDetList> Exporter = new ObjectListHelper<CotizacionDet, CotizacionDetList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of CotizacionDet entities.
    ''' </summary>

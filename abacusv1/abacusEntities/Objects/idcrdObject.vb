...
' This is a partial class file. The other one is idcrdObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of idcrd table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of idcrd table.
    ''' </summary>
    Public Partial Class idcrdObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of idcrdObject, idcrdObjectList) = New ObjectListHelper(Of idcrdObject, idcrdObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of idcrdObjects.
    ''' </summary>

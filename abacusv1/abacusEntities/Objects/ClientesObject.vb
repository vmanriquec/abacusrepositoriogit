...
' This is a partial class file. The other one is ClientesObject.Auto.vb
...
Namespace Objects
    ...
    Public Partial Class ClientesObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ClientesObject, ClientesObjectList) = New ObjectListHelper(Of ClientesObject, ClientesObjectList)()

...
' This is a partial class file. The other one is MarcasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Marcas table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Marcas table.
    ''' </summary>
    Public Partial Class MarcasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of MarcasObject, MarcasObjectList) = New ObjectListHelper(Of MarcasObject, MarcasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of MarcasObjects.
    ''' </summary>

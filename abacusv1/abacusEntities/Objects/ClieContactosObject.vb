...
' This is a partial class file. The other one is ClieContactosObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of ClieContactos table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of ClieContactos table.
    ''' </summary>
    Public Partial Class ClieContactosObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ClieContactosObject, ClieContactosObjectList) = New ObjectListHelper(Of ClieContactosObject, ClieContactosObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ClieContactosObjects.
    ''' </summary>

...
' This is a partial class file. The other one is usuarioObject.Auto.vb
...
Namespace Objects
    ...
    Public Partial Class usuarioObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of usuarioObject, usuarioObjectList) = New ObjectListHelper(Of usuarioObject, usuarioObjectList)()

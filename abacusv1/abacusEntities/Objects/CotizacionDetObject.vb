...
' This is a partial class file. The other one is CotizacionDetObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of CotizacionDet table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of CotizacionDet table.
    ''' </summary>
    Public Partial Class CotizacionDetObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of CotizacionDetObject, CotizacionDetObjectList) = New ObjectListHelper(Of CotizacionDetObject, CotizacionDetObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of CotizacionDetObjects.
    ''' </summary>

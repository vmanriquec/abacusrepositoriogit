...
' This is a partial class file. The other one is ProvinciasObject.Auto.vb
...
Namespace Objects
    ...
    Public Partial Class ProvinciasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ProvinciasObject, ProvinciasObjectList) = New ObjectListHelper(Of ProvinciasObject, ProvinciasObjectList)()

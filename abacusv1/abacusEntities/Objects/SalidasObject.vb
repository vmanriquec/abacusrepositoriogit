...
' This is a partial class file. The other one is SalidasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Salidas table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Salidas table.
    ''' </summary>
    Public Partial Class SalidasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of SalidasObject, SalidasObjectList) = New ObjectListHelper(Of SalidasObject, SalidasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of SalidasObjects.
    ''' </summary>

...
' This is a partial class file. The other one is FacturaDetObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of FacturaDet table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of FacturaDet table.
    ''' </summary>
    Public Partial Class FacturaDetObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of FacturaDetObject, FacturaDetObjectList) = New ObjectListHelper(Of FacturaDetObject, FacturaDetObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of FacturaDetObjects.
    ''' </summary>

...
' This is a partial class file. The other one is FormaPagoObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of FormaPago table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of FormaPago table.
    ''' </summary>
    Public Partial Class FormaPagoObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of FormaPagoObject, FormaPagoObjectList) = New ObjectListHelper(Of FormaPagoObject, FormaPagoObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of FormaPagoObjects.
    ''' </summary>

...
' This is a partial class file. The other one is ProductosObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Productos table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Productos table.
    ''' </summary>
    Public Partial Class ProductosObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ProductosObject, ProductosObjectList) = New ObjectListHelper(Of ProductosObject, ProductosObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ProductosObjects.
    ''' </summary>

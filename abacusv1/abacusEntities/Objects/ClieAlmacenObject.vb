...
' This is a partial class file. The other one is ClieAlmacenObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of ClieAlmacen table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of ClieAlmacen table.
    ''' </summary>
    Public Partial Class ClieAlmacenObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ClieAlmacenObject, ClieAlmacenObjectList) = New ObjectListHelper(Of ClieAlmacenObject, ClieAlmacenObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ClieAlmacenObjects.
    ''' </summary>

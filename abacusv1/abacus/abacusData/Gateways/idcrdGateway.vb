...
' This is a partial class file. The other one is idcrdGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between idcrdObject class and idcrd table.
    ''' This class provide CRUD methods for idcrd table.
    ''' </summary>
    Public Partial Class idcrdGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As idcrdObjectList) As Boolean
        '    Select Case action

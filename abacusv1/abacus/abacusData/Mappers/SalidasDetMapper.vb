...
' This is a partial class file. The other one is SalidasDetMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class SalidasDetMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As SalidasDetList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for SalidasDet entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class SalidasDetLoader
    End Class

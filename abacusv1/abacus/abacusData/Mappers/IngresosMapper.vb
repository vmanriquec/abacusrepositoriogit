...
' This is a partial class file. The other one is IngresosMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class IngresosMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As IngresosList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Ingresos entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class IngresosLoader
    End Class

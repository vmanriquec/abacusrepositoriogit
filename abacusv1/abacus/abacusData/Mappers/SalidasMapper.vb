...
' This is a partial class file. The other one is SalidasMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class SalidasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As SalidasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Salidas entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class SalidasLoader
    End Class

...
' This is a partial class file. The other one is TransportistaMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for Transportista entity
    ...
    Public Partial Class TransportistaMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As TransportistaList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Transportista entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class TransportistaLoader
    End Class

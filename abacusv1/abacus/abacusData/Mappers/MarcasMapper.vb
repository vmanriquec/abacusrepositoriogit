...
' This is a partial class file. The other one is MarcasMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class MarcasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As MarcasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Marcas entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class MarcasLoader
    End Class

...
' This is a partial class file. The other one is FacturaDetMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class FacturaDetMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As FacturaDetList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for FacturaDet entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class FacturaDetLoader
    End Class

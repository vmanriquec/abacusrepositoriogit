...
' This is a partial class file. The other one is FacturaObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Factura table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Factura table.
    ''' </summary>
    Public Partial Class FacturaObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of FacturaObject, FacturaObjectList) = New ObjectListHelper(Of FacturaObject, FacturaObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of FacturaObjects.
    ''' </summary>

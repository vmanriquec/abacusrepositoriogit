...
' This is a partial class file. The other one is SalidasDetObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of SalidasDet table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of SalidasDet table.
    ''' </summary>
    Public Partial Class SalidasDetObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of SalidasDetObject, SalidasDetObjectList) = New ObjectListHelper(Of SalidasDetObject, SalidasDetObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of SalidasDetObjects.
    ''' </summary>

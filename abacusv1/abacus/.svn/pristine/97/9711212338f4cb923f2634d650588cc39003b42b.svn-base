...
' This is a partial class file. The other one is FormaPagoMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class FormaPagoMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As FormaPagoList) As Boolean
        '    Select Case action
        ...
        Public Shared Function cargarnombreformapagocargocombo() As DataTable
            Using cn As New SqlConnection(cox)
                Using cmd As New SqlCommand("coop_FormaPago_GetAll", cn)
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for FormaPago entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class FormaPagoLoader
    End Class

...
' This is a partial class file. The other one is MonedasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Monedas table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Monedas table.
    ''' </summary>
    Public Partial Class MonedasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of MonedasObject, MonedasObjectList) = New ObjectListHelper(Of MonedasObject, MonedasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of MonedasObjects.
    ''' </summary>

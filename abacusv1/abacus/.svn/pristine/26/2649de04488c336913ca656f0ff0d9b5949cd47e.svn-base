...
' This is a partial class file. The other one is MarcasGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between MarcasObject class and Marcas table.
    ''' This class provide CRUD methods for Marcas table.
    ''' </summary>
    Public Partial Class MarcasGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As MarcasObjectList) As Boolean
        '    Select Case action

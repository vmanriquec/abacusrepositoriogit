...
' This is a partial class file. The other one is ProvContactosMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for ProvContactos entity
    ...
    Public Partial Class ProvContactosMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ProvContactosList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for ProvContactos entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ProvContactosLoader
    End Class

...
' This is a partial class file. The other one is IngresosDetEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the IngresosDet entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of IngresosDet entity.
    ''' </summary>
    Public Partial Class IngresosDetList
         ...
         '    ObjectListHelper<IngresosDet, IngresosDetList> Exporter = new ObjectListHelper<IngresosDet, IngresosDetList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of IngresosDet entities.
    ''' </summary>

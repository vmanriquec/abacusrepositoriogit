...
' This is a partial class file. The other one is IngresosDetObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of IngresosDet table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of IngresosDet table.
    ''' </summary>
    Public Partial Class IngresosDetObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of IngresosDetObject, IngresosDetObjectList) = New ObjectListHelper(Of IngresosDetObject, IngresosDetObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of IngresosDetObjects.
    ''' </summary>

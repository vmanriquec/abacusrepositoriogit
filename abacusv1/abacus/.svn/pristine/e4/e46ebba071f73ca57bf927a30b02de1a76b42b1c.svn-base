...
' This is a partial class file. The other one is SalidasDetEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the SalidasDet entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of SalidasDet entity.
    ''' </summary>
    Public Partial Class SalidasDetList
         ...
         '    ObjectListHelper<SalidasDet, SalidasDetList> Exporter = new ObjectListHelper<SalidasDet, SalidasDetList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of SalidasDet entities.
    ''' </summary>

...
' This is a partial class file. The other one is ProvContactosObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of ProvContactos table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of ProvContactos table.
    ''' </summary>
    Public Partial Class ProvContactosObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ProvContactosObject, ProvContactosObjectList) = New ObjectListHelper(Of ProvContactosObject, ProvContactosObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ProvContactosObjects.
    ''' </summary>

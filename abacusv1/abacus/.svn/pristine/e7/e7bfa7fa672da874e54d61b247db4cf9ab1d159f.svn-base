...
' This is a partial class file. The other one is KardexGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between KardexObject class and Kardex table.
    ''' This class provide CRUD methods for Kardex table.
    ''' </summary>
    Public Partial Class KardexGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As KardexObjectList) As Boolean
        '    Select Case action

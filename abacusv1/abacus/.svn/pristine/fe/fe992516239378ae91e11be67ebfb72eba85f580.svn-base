...
' This is a partial class file. The other one is ClieContactosMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for ClieContactos entity
    ...
    Public Partial Class ClieContactosMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ClieContactosList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for ClieContactos entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ClieContactosLoader
    End Class

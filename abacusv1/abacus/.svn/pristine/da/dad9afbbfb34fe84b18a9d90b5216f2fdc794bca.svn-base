...
' This is a partial class file. The other one is tipousuarioObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of tipousuario table.
    ''' </summary>
    <Serializable()> _
    Public Partial Class tipousuarioObject        
        ...
        '     If (Me.idtipousuario <= 0) Then Throw New RuleValidationException(String.Format(msgOutOfRange, "idtipousuario"))
        
        ' End Sub       
    End Class

    ''' <summary>
    ''' This class represents a record set of tipousuario table.
    ''' </summary>
    Public Partial Class tipousuarioObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of tipousuarioObject, tipousuarioObjectList) = New ObjectListHelper(Of tipousuarioObject, tipousuarioObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of tipousuarioObjects.
    ''' </summary>

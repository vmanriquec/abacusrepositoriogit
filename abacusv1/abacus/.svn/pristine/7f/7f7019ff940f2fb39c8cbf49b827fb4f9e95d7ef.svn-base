...
' This is a partial class file. The other one is IngresosObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Ingresos table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Ingresos table.
    ''' </summary>
    Public Partial Class IngresosObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of IngresosObject, IngresosObjectList) = New ObjectListHelper(Of IngresosObject, IngresosObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of IngresosObjects.
    ''' </summary>

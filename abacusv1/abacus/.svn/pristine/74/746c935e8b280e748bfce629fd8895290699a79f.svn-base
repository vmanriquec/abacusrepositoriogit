...
' This is a partial class file. The other one is registrodevisitasEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the registrodevisitas entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of registrodevisitas entity.
    ''' </summary>
    Public Partial Class registrodevisitasList
         ...
         '    ObjectListHelper<registrodevisitas, registrodevisitasList> Exporter = new ObjectListHelper<registrodevisitas, registrodevisitasList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of registrodevisitas entities.
    ''' </summary>

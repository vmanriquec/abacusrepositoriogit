...
' This is a partial class file. The other one is rutaGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between rutaObject class and ruta table.
    ''' This class provide CRUD methods for ruta table.
    ''' </summary>
    Public Partial Class rutaGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As rutaObjectList) As Boolean
        '    Select Case action

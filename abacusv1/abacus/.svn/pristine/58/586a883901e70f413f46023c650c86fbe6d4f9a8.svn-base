...
' This is a partial class file. The other one is KardexObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Kardex table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Kardex table.
    ''' </summary>
    Public Partial Class KardexObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of KardexObject, KardexObjectList) = New ObjectListHelper(Of KardexObject, KardexObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of KardexObjects.
    ''' </summary>

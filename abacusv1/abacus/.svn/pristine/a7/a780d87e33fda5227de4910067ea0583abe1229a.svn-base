...
' This is a partial class file. The other one is DistritosObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Distritos table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Distritos table.
    ''' </summary>
    Public Partial Class DistritosObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of DistritosObject, DistritosObjectList) = New ObjectListHelper(Of DistritosObject, DistritosObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of DistritosObjects.
    ''' </summary>

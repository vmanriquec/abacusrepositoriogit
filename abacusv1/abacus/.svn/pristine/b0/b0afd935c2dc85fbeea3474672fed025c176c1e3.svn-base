...
' This is a partial class file. The other one is CotizacionDetMapper.Auto.cs
...
Namespace Mappers
    ...
    ''' <summary>
    ''' Mapper for CotizacionDet entity
    ...
    Public Partial Class CotizacionDetMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As CotizacionDetList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for CotizacionDet entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class CotizacionDetLoader
    End Class

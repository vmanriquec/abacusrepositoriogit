...
' This is a partial class file. The other one is MovilesMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class MovilesMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As MovilesList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Moviles entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class MovilesLoader
    End Class

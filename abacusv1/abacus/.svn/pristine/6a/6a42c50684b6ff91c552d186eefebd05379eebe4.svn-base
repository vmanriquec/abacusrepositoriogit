...
' This is a partial class file. The other one is TipoCliProvMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class TipoCliProvMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As TipoCliProvList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for TipoCliProv entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class TipoCliProvLoader
    End Class

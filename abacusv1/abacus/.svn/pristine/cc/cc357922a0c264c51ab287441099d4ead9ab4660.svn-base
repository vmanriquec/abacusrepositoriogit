...
' This is a partial class file. The other one is LoginObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Login table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Login table.
    ''' </summary>
    Public Partial Class LoginObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of LoginObject, LoginObjectList) = New ObjectListHelper(Of LoginObject, LoginObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of LoginObjects.
    ''' </summary>

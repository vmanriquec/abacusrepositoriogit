...
' This is a partial class file. The other one is FacturaMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class FacturaMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As FacturaList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Factura entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class FacturaLoader
    End Class

...
' This is a partial class file. The other one is rutaObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of ruta table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of ruta table.
    ''' </summary>
    Public Partial Class rutaObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of rutaObject, rutaObjectList) = New ObjectListHelper(Of rutaObject, rutaObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of rutaObjects.
    ''' </summary>

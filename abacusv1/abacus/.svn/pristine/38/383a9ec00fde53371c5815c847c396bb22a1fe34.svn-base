...
' This is a partial class file. The other one is GuiasDetObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of GuiasDet table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of GuiasDet table.
    ''' </summary>
    Public Partial Class GuiasDetObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of GuiasDetObject, GuiasDetObjectList) = New ObjectListHelper(Of GuiasDetObject, GuiasDetObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of GuiasDetObjects.
    ''' </summary>

...
' This is a partial class file. The other one is tipousuarioMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class tipousuarioMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As tipousuarioList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for tipousuario entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class tipousuarioLoader
    End Class

...
' This is a partial class file. The other one is MovilesObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Moviles table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Moviles table.
    ''' </summary>
    Public Partial Class MovilesObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of MovilesObject, MovilesObjectList) = New ObjectListHelper(Of MovilesObject, MovilesObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of MovilesObjects.
    ''' </summary>

...
' This is a partial class file. The other one is ProductosMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class ProductosMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ProductosList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Productos entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ProductosLoader
    End Class

...
' This is a partial class file. The other one is CotizacionMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class CotizacionMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As CotizacionList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Cotizacion entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class CotizacionLoader
    End Class

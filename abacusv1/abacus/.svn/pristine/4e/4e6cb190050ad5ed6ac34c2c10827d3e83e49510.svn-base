...
Namespace Mappers
    ...
    Public Partial Class FamiliasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As FamiliasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' </summary>
    Public Partial Class FamiliasLoader
    End Class

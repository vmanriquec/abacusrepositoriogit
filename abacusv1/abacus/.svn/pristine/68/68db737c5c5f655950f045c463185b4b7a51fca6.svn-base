...
' This is a partial class file. The other one is LoginGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between LoginObject class and Login table.
    ''' This class provide CRUD methods for Login table.
    ''' </summary>
    Public Partial Class LoginGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As LoginObjectList) As Boolean
        '    Select Case action

...
' This is a partial class file. The other one is FamiliasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Familias table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Familias table.
    ''' </summary>
    Public Partial Class FamiliasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of FamiliasObject, FamiliasObjectList) = New ObjectListHelper(Of FamiliasObject, FamiliasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of FamiliasObjects.
    ''' </summary>

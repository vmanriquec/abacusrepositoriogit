...
' This is a partial class file. The other one is cargopersonalObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of cargopersonal table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of cargopersonal table.
    ''' </summary>
    Public Partial Class cargopersonalObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of cargopersonalObject, cargopersonalObjectList) = New ObjectListHelper(Of cargopersonalObject, cargopersonalObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of cargopersonalObjects.
    ''' </summary>

...
' This is a partial class file. The other one is idcrdMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class idcrdMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As idcrdList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for idcrd entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class idcrdLoader
    End Class

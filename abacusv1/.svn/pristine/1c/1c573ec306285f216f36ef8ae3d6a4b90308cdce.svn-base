...
' This is a partial class file. The other one is TrabajadoresObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Trabajadores table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Trabajadores table.
    ''' </summary>
    Public Partial Class TrabajadoresObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of TrabajadoresObject, TrabajadoresObjectList) = New ObjectListHelper(Of TrabajadoresObject, TrabajadoresObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of TrabajadoresObjects.
    ''' </summary>

...
' This is a partial class file. The other one is GuiasDetMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class GuiasDetMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As GuiasDetList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for GuiasDet entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class GuiasDetLoader
    End Class

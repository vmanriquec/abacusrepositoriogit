...
' This is a partial class file. The other one is usuarioMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class usuarioMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As usuarioList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for usuario entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class usuarioLoader
    End Class

...
' This is a partial class file. The other one is registrodevisitasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of registrodevisitas table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of registrodevisitas table.
    ''' </summary>
    Public Partial Class registrodevisitasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of registrodevisitasObject, registrodevisitasObjectList) = New ObjectListHelper(Of registrodevisitasObject, registrodevisitasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of registrodevisitasObjects.
    ''' </summary>

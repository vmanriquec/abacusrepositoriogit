...
' This is a partial class file. The other one is AlmacenesObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Almacenes table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Almacenes table.
    ''' </summary>
    Public Partial Class AlmacenesObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of AlmacenesObject, AlmacenesObjectList) = New ObjectListHelper(Of AlmacenesObject, AlmacenesObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of AlmacenesObjects.
    ''' </summary>

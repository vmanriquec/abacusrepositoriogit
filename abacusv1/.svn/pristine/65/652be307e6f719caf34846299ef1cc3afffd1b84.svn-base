...
' This is a partial class file. The other one is TipoCliProvObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of TipoCliProv table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of TipoCliProv table.
    ''' </summary>
    Public Partial Class TipoCliProvObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of TipoCliProvObject, TipoCliProvObjectList) = New ObjectListHelper(Of TipoCliProvObject, TipoCliProvObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of TipoCliProvObjects.
    ''' </summary>

...
' This is a partial class file. The other one is ProductosEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Productos entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Productos entity.
    ''' </summary>
    Public Partial Class ProductosList
         ...
         '    ObjectListHelper<Productos, ProductosList> Exporter = new ObjectListHelper<Productos, ProductosList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Productos entities.
    ''' </summary>

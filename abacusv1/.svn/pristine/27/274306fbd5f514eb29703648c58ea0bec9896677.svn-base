...
' This is a partial class file. The other one is IngresosEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Ingresos entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Ingresos entity.
    ''' </summary>
    Public Partial Class IngresosList
         ...
         '    ObjectListHelper<Ingresos, IngresosList> Exporter = new ObjectListHelper<Ingresos, IngresosList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Ingresos entities.
    ''' </summary>

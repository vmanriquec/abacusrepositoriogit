...
' This is a partial class file. The other one is ChoferesObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Choferes table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Choferes table.
    ''' </summary>
    Public Partial Class ChoferesObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ChoferesObject, ChoferesObjectList) = New ObjectListHelper(Of ChoferesObject, ChoferesObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ChoferesObjects.
    ''' </summary>

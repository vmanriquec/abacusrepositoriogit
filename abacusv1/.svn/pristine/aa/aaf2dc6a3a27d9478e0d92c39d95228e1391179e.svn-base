...
' This is a partial class file. The other one is TCObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of TC table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of TC table.
    ''' </summary>
    Public Partial Class TCObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of TCObject, TCObjectList) = New ObjectListHelper(Of TCObject, TCObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of TCObjects.
    ''' </summary>

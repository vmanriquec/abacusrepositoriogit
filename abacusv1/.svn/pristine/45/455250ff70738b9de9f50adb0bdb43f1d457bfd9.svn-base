...
' This is a partial class file. The other one is TrabajadoresEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Trabajadores entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Trabajadores entity.
    ''' </summary>
    Public Partial Class TrabajadoresList
         ...
         '    ObjectListHelper<Trabajadores, TrabajadoresList> Exporter = new ObjectListHelper<Trabajadores, TrabajadoresList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Trabajadores entities.
    ''' </summary>

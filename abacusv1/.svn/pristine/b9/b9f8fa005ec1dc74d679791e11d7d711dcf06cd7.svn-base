...
' This is a partial class file. The other one is ProveedoresMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class ProveedoresMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As ProveedoresList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Proveedores entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class ProveedoresLoader
    End Class

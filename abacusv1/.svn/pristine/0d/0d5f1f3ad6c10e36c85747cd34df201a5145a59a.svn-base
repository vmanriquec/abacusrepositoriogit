...
Protected _valortotal As System.Nullable(Of System.Decimal) 
...
#Region "Properties"
        ...
        ''' Nullable property
        ''' </summary>
        Public Overridable Property valortotal As System.Nullable(Of System.Decimal) 
            Get        
                Return _valortotal
            End Get
        ...
        Private Function GetFieldsForInsert() As Object() Implements IMappeableIngresosObject.GetFieldsForInsert
			...
			If (Not System.String.IsNullOrEmpty(_estado)) Then _myArray(11) = _estado
			If (_valortotal.HasValue) Then _myArray(12) = _valortotal.Value
			If (Not System.String.IsNullOrEmpty(_lote)) Then _myArray(13) = _lote

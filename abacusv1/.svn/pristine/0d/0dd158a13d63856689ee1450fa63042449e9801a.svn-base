...
' This is a partial class file. The other one is GuiasMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class GuiasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As GuiasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Guias entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class GuiasLoader
    End Class

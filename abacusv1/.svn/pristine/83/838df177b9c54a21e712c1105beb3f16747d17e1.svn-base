...
' This is a partial class file. The other one is ProveedoresObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Proveedores table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Proveedores table.
    ''' </summary>
    Public Partial Class ProveedoresObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of ProveedoresObject, ProveedoresObjectList) = New ObjectListHelper(Of ProveedoresObject, ProveedoresObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ProveedoresObjects.
    ''' </summary>

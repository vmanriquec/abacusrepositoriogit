...
' This is a partial class file. The other one is FacturaDetEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the FacturaDet entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of FacturaDet entity.
    ''' </summary>
    Public Partial Class FacturaDetList
         ...
         '    ObjectListHelper<FacturaDet, FacturaDetList> Exporter = new ObjectListHelper<FacturaDet, FacturaDetList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of FacturaDet entities.
    ''' </summary>

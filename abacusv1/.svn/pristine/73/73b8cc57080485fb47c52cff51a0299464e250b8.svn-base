...
' This is a partial class file. The other one is FacturaEntity.cs
...
Namespace Entities
    ...
    Public Partial Class Factura
        Inherits Objects.FacturaObject
        Implements IMappeableFactura
        Implements IEquatable(Of Factura)
...
End If
        ...
        ''' </summary>
        Public Shadows Function OriginalValue() As Factura 
                Return CType(MyBase.OriginalValue, Factura)
        End Function
        ...
        Protected Overrides Function Clone() As Object 
            Dim newObject As Factura 
            

            newObject = CType(Me.MemberwiseClone(), Factura)
            ' Entities
            ...
            ' OriginalValue
            Dim newOriginalValue As Factura
            If MyBase.InternalOriginalValue IsNot Nothing Then
                newOriginalValue = CType(Me.OriginalValue().MemberwiseClone(), Factura)
                ' Entities
        ...
        Private Sub CompleteEntity(AlmacenesEntity As Objects.AlmacenesObject, ClientesEntity As Objects.ClientesObject, TrabajadoresEntity As Objects.TrabajadoresObject) Implements IMappeableFactura.CompleteEntity
...
_TrabajadoresEntity = TrabajadoresEntity
        ...
        Private Function IsAlmacenesEntityNull() As Boolean Implements IMappeableFactura.IsAlmacenesEntityNull
            Return IsNothing(_AlmacenesEntity)
        End Function
        
        Private Function IsClientesEntityNull() As Boolean Implements IMappeableFactura.IsClientesEntityNull
            Return IsNothing(_ClientesEntity)
        End Function
        
        Private Function IsTrabajadoresEntityNull() As Boolean Implements IMappeableFactura.IsTrabajadoresEntityNull
            Return IsNothing(_TrabajadoresEntity)
        End Function
        

        Private Sub SetFKValuesForChilds(entity As Factura) Implements IMappeableFactura.SetFKValuesForChilds
                
        End Sub

        Public Overloads Function Equals(other As Factura) As Boolean Implements IEquatable(Of Factura).Equals
            Return UniqueIdentifierHelper.IsSameObject(CType(Me, IUniqueIdentifiable), CType(other, IUniqueIdentifiable))
        End Function

    End Class

    Public Interface IMappeableFactura
        Sub CompleteEntity(AlmacenesEntity As Objects.AlmacenesObject, ClientesEntity As Objects.ClientesObject, TrabajadoresEntity As Objects.TrabajadoresObject)
        ...
        Sub SetFKValuesForChilds(entity As Factura )
    End Interface

    Public Partial Class FacturaList
        Inherits ObjectList(Of Factura)    
    End Class
End Namespace

Namespace Views
    Partial Public Class FacturaListView
        Inherits ObjectListView(Of Entities.Factura)

        Sub New(ByVal list As Entities.FacturaList)
            MyBase.New(list)
        End Sub
    End Class
End NameSpace

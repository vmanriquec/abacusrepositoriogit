...
End If
Dim _PrecioVenta As System.Nullable(Of System.Decimal) 
If reader.IsDBNull(16) Then 
	 _PrecioVenta = New System.Nullable(Of System.Decimal)
Else
	 _PrecioVenta = reader.GetDecimal(16)
End If
...
End If
Dim _fechaingreso As System.Nullable(Of System.DateTime) 
If reader.IsDBNull(19) Then 
	 _fechaingreso = New System.Nullable(Of System.DateTime)
Else
	 _fechaingreso = reader.GetDateTime(19)
End If
Dim _fechadecaducidad As System.Nullable(Of System.DateTime) 
If reader.IsDBNull(20) Then 
	 _fechadecaducidad = New System.Nullable(Of System.DateTime)
Else
	 _fechadecaducidad = reader.GetDateTime(20)
End If
Dim _estado As String
If reader.IsDBNull(21) Then 
	 _estado = ""
Else
	 _estado = reader.GetString(21)
End If
Dim _fotoproducto(0) As System.Byte: If Not reader.IsDBNull(22) Then _fotoproducto = TryCast(reader.GetValue(22), Byte())
Dim _ProveedoresString As String
If reader.IsDBNull(23) Then 
	 _ProveedoresString = ""
Else
	 _ProveedoresString = reader.GetString(23)
End If
Dim _TipoProductoString As String
If reader.IsDBNull(24) Then 
	 _TipoProductoString = ""
Else
	 _TipoProductoString = reader.GetString(24)
End If
...
Namespace Wrappers
    ...
    Public Class ProductosMapperWrapper
        ...
        Public Overloads Sub Save(ByVal IdProducto As System.Int32, ByVal IdProveedor As System.Int32, ByVal Id_TipoProducto As System.Int32, ByVal CodProducto As System.String, ByVal Producto As System.String, ByVal TipoProducto As System.Int32, ByVal Capacidad As System.String, ByVal UMedida As System.String, ByVal NumParte As System.String, ByVal Familia As System.Int32, ByVal Categoria As System.Int32, ByVal Observaciones As System.String, ByVal IdProveedores As System.String, ByVal ImagenProd As System.String, ByVal PrecioCosto As System.Decimal, ByVal MonedaC As System.Int32, ByVal PrecioVenta As System.Decimal, ByVal MonedaV As System.Int32, ByVal upsize_ts As System.DateTime, ByVal fechaingreso As System.DateTime, ByVal fechadecaducidad As System.DateTime, ByVal estado As System.String, ByVal ProveedoresString As System.String, ByVal TipoProductoString As System.String)
            ...
            entity.fechaingreso = fechaingreso
            entity.fechadecaducidad = fechadecaducidad
        ...
        ''' Insert Productos
        ''' </summary>
        Public Overloads Sub Insert(ByVal IdProveedor As System.Int32, ByVal Id_TipoProducto As System.Int32, ByVal CodProducto As System.String, ByVal Producto As System.String, ByVal TipoProducto As System.Int32, ByVal Capacidad As System.String, ByVal UMedida As System.String, ByVal NumParte As System.String, ByVal Familia As System.Int32, ByVal Categoria As System.Int32, ByVal Observaciones As System.String, ByVal IdProveedores As System.String, ByVal ImagenProd As System.String, ByVal PrecioCosto As System.Decimal, ByVal MonedaC As System.Int32, ByVal PrecioVenta As System.Decimal, ByVal MonedaV As System.Int32, ByVal upsize_ts As System.DateTime, ByVal fechaingreso As System.DateTime, ByVal fechadecaducidad As System.DateTime, ByVal estado As System.String)
...
Else
	 _estado = reader.GetString(21)
End If
Dim _fotoproducto(0) As System.Byte: If Not reader.IsDBNull(22) Then reader.GetBytes(22, 0, _fotoproducto, 0, 0)
Dim _ProveedoresString As String
If reader.IsDBNull(23) Then 
	 _ProveedoresString = ""
Else

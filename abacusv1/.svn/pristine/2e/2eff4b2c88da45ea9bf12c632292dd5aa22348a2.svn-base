...
' This is a partial class file. The other one is ClieAlmacenEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the ClieAlmacen entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of ClieAlmacen entity.
    ''' </summary>
    Public Partial Class ClieAlmacenList
         ...
         '    ObjectListHelper<ClieAlmacen, ClieAlmacenList> Exporter = new ObjectListHelper<ClieAlmacen, ClieAlmacenList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of ClieAlmacen entities.
    ''' </summary>

...
' This is a partial class file. The other one is TCGateway.Auto.vb
...
Namespace Gateways
    ...
    ''' <summary>
    ''' Gateway between TCObject class and TC table.
    ''' This class provide CRUD methods for TC table.
    ''' </summary>
    Public Partial Class TCGateway
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As TCObjectList) As Boolean
        '    Select Case action

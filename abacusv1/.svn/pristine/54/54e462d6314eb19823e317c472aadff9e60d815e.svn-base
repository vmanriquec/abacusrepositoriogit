...
' This is a partial class file. The other one is TIPOIGVObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of TIPOIGV table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of TIPOIGV table.
    ''' </summary>
    Public Partial Class TIPOIGVObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of TIPOIGVObject, TIPOIGVObjectList) = New ObjectListHelper(Of TIPOIGVObject, TIPOIGVObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of TIPOIGVObjects.
    ''' </summary>

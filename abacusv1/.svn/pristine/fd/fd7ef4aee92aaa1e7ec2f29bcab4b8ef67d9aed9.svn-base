...
' This is a partial class file. The other one is ClientesEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Clientes entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Clientes entity.
    ''' </summary>
    Public Partial Class ClientesList
         ...
         '    ObjectListHelper<Clientes, ClientesList> Exporter = new ObjectListHelper<Clientes, ClientesList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Clientes entities.
    ''' </summary>

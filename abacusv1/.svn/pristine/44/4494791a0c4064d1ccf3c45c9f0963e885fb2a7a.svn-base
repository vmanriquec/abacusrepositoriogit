...
' This is a partial class file. The other one is MotivoSalObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of MotivoSal table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of MotivoSal table.
    ''' </summary>
    Public Partial Class MotivoSalObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of MotivoSalObject, MotivoSalObjectList) = New ObjectListHelper(Of MotivoSalObject, MotivoSalObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of MotivoSalObjects.
    ''' </summary>

...
' This is a partial class file. The other one is GuiasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Guias table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Guias table.
    ''' </summary>
    Public Partial Class GuiasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of GuiasObject, GuiasObjectList) = New ObjectListHelper(Of GuiasObject, GuiasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of GuiasObjects.
    ''' </summary>

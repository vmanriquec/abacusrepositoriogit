...
' This is a partial class file. The other one is CategoriasObject.Auto.vb
...
Namespace Objects
    ''' <summary>
    ''' This class represents a Object of Categorias table.
    ''' </summary>
    <Serializable()> _
    ...
    ''' <summary>
    ''' This class represents a record set of Categorias table.
    ''' </summary>
    Public Partial Class CategoriasObjectList
         ...
         '    Dim Exporter As ObjectListHelper(Of CategoriasObject, CategoriasObjectList) = New ObjectListHelper(Of CategoriasObject, CategoriasObjectList)()
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of CategoriasObjects.
    ''' </summary>

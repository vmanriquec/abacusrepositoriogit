...
' This is a partial class file. The other one is MonedasMapper.Auto.cs
...
Namespace Mappers
    ...
    Public Partial Class MonedasMapper
        ...
        ' ''' </summary>
        'Protected Overrides Function CheckForSecurityRights(ByVal action As SecurityRights, ByVal ObjectListOrEntityList As MonedasList) As Boolean
        '    Select Case action
...
Namespace Loaders
    ...
    ''' <summary>
    ''' Loader for Monedas entity
    ''' This class provide get methods for this entity
    ''' </summary>
    Public Partial Class MonedasLoader
    End Class

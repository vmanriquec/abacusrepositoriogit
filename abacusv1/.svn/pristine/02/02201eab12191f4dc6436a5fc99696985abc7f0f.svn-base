...
' This is a partial class file. The other one is KardexEntity.Auto.cs
...
Namespace Entities
    ''' <summary>
    ''' This class represents the Kardex entity.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    ...
    ''' <summary>
    ''' This class represents a collection of Kardex entity.
    ''' </summary>
    Public Partial Class KardexList
         ...
         '    ObjectListHelper<Kardex, KardexList> Exporter = new ObjectListHelper<Kardex, KardexList>();
...
Namespace Views
    ''' <summary>
    ''' This class represents a view of an collection of Kardex entities.
    ''' </summary>
